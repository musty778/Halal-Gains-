-- Fix Weight Tracking - Safe to run multiple times
...
-- Create policies (after dropping them above)
...
DROP FUNCTION IF EXISTS record_weekly_weight(UUID, INTEGER, DECIMAL);
